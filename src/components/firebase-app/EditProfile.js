		...
		<>
			...
			{ user ? 
				...
				<form onSubmit={handleEdit} className="mx-auto my-4 w-100" style={{maxWidth: "500px"}}>
					...
					<input type="text" name="displayName" className="form-control mt-2 mb-3" placeholder={user.displayName} onChange={(e) => setDisplayName(e.target.value)} />
					<label htmlFor="avatar">Edit Avatar</label>
					<input type="text" name="avatar" className="form-control my-2" placeholder={user.photoURL} onChange={(e) => setAvatar(e.target.value)} />
